...
def check_torch_mps():
    ...
    if torch.backends.mps.is_available():
        logger.info("MPS is available on this MacOS version.")
    else:
        logger.warning("MPS is not available on this MacOS version.")

    if torch.backends.mps.is_built():
        logger.info("PyTorch was built with MPS activated.")
    else:
        logger.warning("PyTorch was not built with MPS activated.")
