...
from common.data_fetcher import df_daily_sales_da
from common.data_fetcher import df_price_regression_tab
from common.data_fetcher import df_price_sensing_tab
